            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class='btn btn-sm btn-primary' href='tambah_produk.php'>Tambah</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>";
                                        echo "<a class='btn btn-sm btn-primary' href='edit_produk.php?id=" . $row["product_id"] . "'>Edit</a>";
                                        echo"<a class='btn btn-sm btn-danger' style='margin-top: 10px;' href='hapus_produk.php?id=" . $row["product_id"] . "' onclick=\"return confirm('Yakin ingin menghapus produk ini?');\">Hapus</a>";
                                        echo "</td>";
                                    }
                                } else {
